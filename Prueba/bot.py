...
def chat_bot():
    ...
    while True:
        ...
        if best_match:
            ...
            print(f"Bender: {answer}")
        else:
            print("Bender: No conozco esa pregunta. ¿Podrías enseñarme cómo debería responder a ella por favor?")
            ...
            if new_answer.lower() != "salir":
                ...
                print('Bender: ¡Gracias por tu tiempo! Aprendí una nueva pregunta que me ayudará a mejorar.')
